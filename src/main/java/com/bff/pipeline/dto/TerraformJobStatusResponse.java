 ...
 * 사유 텍스트 {@code failReason}만 읽고 나머지는 무시한다.
 *
 * {@code terraformState}는 String이다 — 전체 값 목록이 미확정이라(설계 §6 TODO) terminal 세 값
...
public record TerraformJobStatusResponse(String terraformState, String failReason) {
}
