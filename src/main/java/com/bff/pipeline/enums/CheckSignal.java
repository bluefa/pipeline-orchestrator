 ...
 * {@link #RUNNING}/{@link #NOT_MET}으로 보고하고, 호출 자체가 실패하면 엔진이
 * {@link #API_ERROR}/{@link #CALL_TIMEOUT}으로 보고한다.
 *
 * <p>{@code RUNNING} — terraform 잡이 아직 도는 중. {@code NOT_MET} — 조건이 아직 안 맞음.
 * {@code API_ERROR} — poll 호출이 오류를 반환. {@code CALL_TIMEOUT} — poll 호출이 호출별 타임아웃을 넘김.
 */
