 ...
 *
 * 원인별 의미: {@code JOB_FAILED} — TERRAFORM_JOB 폴링에서 잡이 FAILED로 보고됨.
 * {@code EXECUTION_TIMEOUT} — TERRAFORM_JOB이 태스크별 실행 타임아웃을 넘김.
 * {@code CONDITION_NOT_MET} — CONDITION_CHECK가 재시도 예산(maxFailCount) 안에 조건을 충족하지 못함.
...
public enum ErrorCode {
    ...
    EXECUTION_TIMEOUT,
    /** CONDITION_CHECK가 재시도 예산(maxFailCount) 안에 조건을 충족하지 못한 경우. */
    CONDITION_NOT_MET,
