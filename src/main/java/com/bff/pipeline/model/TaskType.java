...
public interface TaskType {
    ...
    /**
     * 이 타입의 dispatch가 {@code slotCap}으로 제한되는 희소 슬롯(예: terraform 러너 동시성)을 소비하는지 여부다.
     * 엔진은 이 값이 {@code true}인 READY task를 dispatch하기 전에 현재 점유 슬롯 수를 {@code slotCap}과 견준다
     ...
     */
    default boolean consumesDispatchSlot() {
        return false;
    }
}
