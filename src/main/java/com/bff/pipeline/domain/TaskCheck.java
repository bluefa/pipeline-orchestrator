 ...
 * {@code lastResponseCode}/{@code lastResponseSummary} are populated by a future HTTP adapter.
 */
@Entity
@Table(
        name = "task_check",
...
public class TaskCheck {
    ...
    /** A free-form debug label of the last poll (e.g. "RUNNING", "NOT_MET") — never read for logic. */
