 ...
 *
 * <p>활성화되면 {@code infraManagerDelegate} 빈이 생기고, 그러면 기존
 * {@link com.bff.pipeline.client.TimeBoundedInfraManagerClient}({@code @ConditionalOnBean("infraManagerDelegate")}
 * + {@code @Primary})가 켜져 도메인이 호출별 타임아웃 데코레이터를 주입받는다.
 *
