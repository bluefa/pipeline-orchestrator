 ...
 * (1) {@code FeignConfig}가 켜져 {@code infraManagerDelegate}(Feign 어댑터)가 뜨고, (2) 그 존재로
 * {@link TimeBoundedInfraManagerClient}({@code @ConditionalOnBean} + {@code @Primary})가 켜져 도메인이 주입받는
