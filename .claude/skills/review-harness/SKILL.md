...
Four promoted detections (guarded-CAS, targeted-catch → agent; no-hidden-test-tx, exhaustive-switch →
rule) and a watch-list of owner preferences. See [`.claude/review-ledger.md`](../../review-ledger.md).
